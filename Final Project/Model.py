...
def main():
    ...
    df_disease = pd.read_csv("/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Input_Datasets/Diabetes_Set.csv")
    df_healthy = pd.read_csv("/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Input_Datasets/Healthy_Set.csv")
    ...
    number_of_age_groups = int(min(len(df_disease),len(df_healthy))*0.5)
    number_of_locations_at_each_age_group = int((number_of_age_groups*number_of_methylation_sites)/2)
    ...
    print('State Matrix Dimensions', len(state_matrix_healthy_pre_prune),len(state_matrix_healthy_pre_prune[0]), len(state_matrix_healthy_pre_prune[0][0]))
    print('Transition Matrix Dimensions', len(transition_matrix_healthy_pre_prune), len(transition_matrix_healthy_pre_prune[0]), len(transition_matrix_healthy_pre_prune[0][0]))
    #save model to .csv file
    df_state_healthy_pre_prune = pd.DataFrame(state_matrix_healthy_pre_prune)
    df_state_healthy_pre_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_state_healthy_pre_prune.csv')
    df_transition_healthy_pre_prune = pd.DataFrame(transition_matrix_healthy_pre_prune)
    df_transition_healthy_pre_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_transition_healthy_pre_prune.csv')
    #predict age 
    ...
    print('State Matrix Dimensions', len(state_matrix_diseased_pre_prune),len(state_matrix_diseased_pre_prune[0]), len(state_matrix_diseased_pre_prune[0][0]))
    print('Transition Matrix Dimensions', len(transition_matrix_diseased_pre_prune), len(transition_matrix_diseased_pre_prune[0]), len(transition_matrix_diseased_pre_prune[0][0]))
    #save model to .csv file
    df_state_disease_pre_prune = pd.DataFrame(state_matrix_diseased_pre_prune)
    df_state_disease_pre_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_state_disease_pre_prune.csv')
    df_transition_disease_pre_prune = pd.DataFrame(transition_matrix_diseased_pre_prune)
    df_transition_disease_pre_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_transition_disease_pre_prune.csv')
    #predict age
    ...
    print('State Matrix Dimensions', len(state_matrix_healthy),len(state_matrix_healthy[0]), len(state_matrix_healthy[0][0]))
    print('Transition Matrix Dimensions', len(transition_matrix_healthy), len(transition_matrix_healthy[0]), len(transition_matrix_healthy[0][0]))
    #save model to .csv file
    df_state_healthy_post_prune = pd.DataFrame(state_matrix_healthy)
    df_state_healthy_post_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_state_healthy_post_prune.csv')
    df_transition_healthy_post_prune = pd.DataFrame(transition_matrix_healthy)
    df_transition_healthy_post_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_transition_healthy_post_prune.csv')
    #predict age
    ...
    print('State Matrix Dimensions', len(state_matrix_diseased),len(state_matrix_diseased[0]), len(state_matrix_diseased[0][0]))
    print('Transition Matrix Dimensions', len(transition_matrix_diseased), len(transition_matrix_diseased[0]), len(transition_matrix_diseased[0][0]))
    #save model to .csv file
    df_state_disease_post_prune = pd.DataFrame(state_matrix_diseased)
    df_state_disease_post_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_state_disease_post_prune.csv')
    df_transition_disease_post_prune = pd.DataFrame(transition_matrix_diseased)
    df_transition_disease_post_prune.to_csv('/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Markov_Models/df_transition_disease_post_prune.csv')
    #predict age
    ...
    print('\n Condition Prediction')
    df_longitudinal_methylation = pd.read_csv("/Users/raehash/Desktop/CMU Sophomore Year/Fall Semester/02-512 Computational Methods for Biological Modeling and Simulation/Final Project/Input_Datasets/Longitude_Set.csv")
